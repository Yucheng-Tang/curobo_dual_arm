...
@dataclass
class RelativePoseCostConfig(CostConfig):
...
class RelativePoseCostMetric:
    ...
    @classmethod
    def reset_metric(cls) -> RelativePoseCostMetric:
        return RelativePoseCostMetric(
...
class RelativePoseCost(CostBase, RelativePoseCostConfig):
    def __init__(self, config: RelativePoseCostConfig):
        RelativePoseCostConfig.__init__(self, **vars(config))
    ...
    def update_metric(self, metric: RelativePoseCostMetric):
